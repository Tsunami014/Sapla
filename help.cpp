...
"<h2><u>Argument usage</u></h2>"
    ...
    "<ul>"
        ...
        "<li>"+code("|def")+" - if the output is currently null (e.g. no argument or you indexed out of bounds), display the text after instead.</li>"
        "<li>"+code(">cng")+" - if the output is currently <b>NOT</b> null, displays the text after instead. Basically the opposite of |</li>"
