...
"<h2><u>Argument usage</u></h2>"
    "<p>Arguments are specified as either %index (e.g. "+code("%1")+" for the first argument) or "
        ...
        +code("%#")+" or "+code("%0")+" (for every argument separated by space (with spaces escaped; for use with "+code("{")+")) or "
        +code("%*")+" (for every argument separated by |).</p>"
    "<p>"+code("%0")+" is equivalent to "+code("%#")+" and "+code("%*")+" is equivalent to "+code("%0+\\|")+" for convenience</p>"
