...
const QString code(const QString str) {
    static const QString codeRepl = "<span style='"
...
"<h1>FAQ</h1>"
    "<ul>"
        ...
        "<li><b>How do I find the logs/config directory?</b><br>"
            "To see the logs: <b>Help &gt; Logs</b>. Config directory is the first log on the list.</li>"
    "</ul>"
"<h1>Tricks</h1>"
    ...
    "<ul>"
        "<li>"
            ...
            "<p>To get around this, you can do something like this: "+code("[[front1::||front2::]][[::back]]")+". "
                "2 hidden features are used, where one randomly picks one of the fronts to use and the other only appears on the back.</p>"
        "</li>"
    "</ul>"
;
...
"<h2>Note templates</h2>"
    ...
    "<h3>Note template structure</h3>"
        "<p>Note templates are comprised of a header and contents, and are contained in "+code("|| ... ||")+" for usage or "+code("|= ... =|")+" for definitions or "+code("|: ... :|")+" for local definitions (which means the template is only avaliable in that card).</p>"
        ...
        "<p><b>Unlike other features</b>, this will <i>not</i> keep spacing at the start/end of the definition. "
            ...
            "The spacing is <i>only</i> stripped at the start/end of the header, contents or between arguments (e.g. "+code("|| hi | arg1 | arg2 ||")+" -> "+code("||hi|arg1|arg2||")+")</p>"
