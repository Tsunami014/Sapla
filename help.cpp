...
"<h2>Note templates</h2>"
    ...
    "<h3>Arguments</h3>"
        ...
        "<p>For more methods on utilising arguments, see the <b>Help &gt; Argument Help</b> menu.</p>"
;
...
"<ul>"
    ...
    "<li>"+code("[num1:num2")+" - get the <num1>th to <num2>th chars of the input (can both also be negative)"
    ...
    "<li>"+code("{num")+" or "+code("{num1:num2")+" - same as above, but for words instead of characters."
