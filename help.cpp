...
"<h2><u>Equations</u></h2>"
    ...
    "<p>You can also reference other variables, such as: "+code("%1&($a*2)%")+" when used with "+code("[a=%x&($x+1)]")+" (if you didn't specify %x& it would use the literal value)</p>"
...
"<h2><u>Argument tricks</u></h2>"
    "<ul>"
        "<li>You can wrap an argument in something using equations, "
            "e.g. "+code("%1&((+$x+\\))")+" wraps $1 in () brackets</li>"
