...
"<h1><b>IMPORTANT THINGS</b></h1>"
    "<ul>"
        ...
        "<li>"
            ...
            "<p>For example, this `||hi | [[bye1::bye2]]||` is ok because they are different but this `[[bye1||[[front::back]]||bye3]]` is not ok.</p>"
            "<p>See 'Tricks' below for some workarounds, or come up with your own, or make an extension if you care enough &lt;3</p>"
        "</li>"
    "</ul>"
...
"<h1>Tricks</h1>"
    ...
    "<ul>"
        "<li>"
            ...
            "<p>To get around this, you can do something like this: `[[front1::||front2::]][[::back]]`. "
...
"<h2>Markdown support</h2>"
    "<p>This app contains various ways to markup your text; (some couldn't be styled literally in this menu, don't worry about it)</p>"
    "<ul>"
        "<li>*<i>italics</i>*</li>"
        "<li>**<b>bold</b>**</li>"
